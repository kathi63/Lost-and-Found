...
public class FoundQuery extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_found_query);

        progressDialog = new ProgressDialog(this);
        userImage = findViewById(R.id.f_chooseImage);
        lItemName = findViewById(R.id.f_Item_name);
        lMessage = findViewById(R.id.f_message);
        lContact = findViewById(R.id.f_contact);
        lLocation = findViewById(R.id.f_location);
        lSubmitButton = findViewById(R.id.f_SubmitButton);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(FoundQuery.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.category));
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        spinner.setAdapter(adapter);
        spinner.setOnItemSelectedListener(this);

        editDate = findViewById(R.id.f_date);
        ...
        editDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(FoundQuery.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        editTime = findViewById(R.id.f_time);
        editTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timePickerDialog = new TimePickerDialog(FoundQuery.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                if (imageUri != null) {
                    ...
                    fStore.collection("Item_Details").add(userMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            ...
                            Toast.makeText(getApplicationContext(), "Found Query is created.", Toast.LENGTH_SHORT).show();

                            FcmNotificationsSender notificationsSender = new FcmNotificationsSender("/topics/all", notificationTitle, notificationMessage, getApplicationContext(), FoundQuery.this);
                    ...
                    Intent intent = new Intent(FoundQuery.this, ListQueries.class);
    ...
    public void uploadImage() {
        try {
            if (imageUri!=null) {
                ...
                ProgressDialog pd = new ProgressDialog(FoundQuery.this);
                ...
                objectUploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(FoundQuery.this, "Failed to upload", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
